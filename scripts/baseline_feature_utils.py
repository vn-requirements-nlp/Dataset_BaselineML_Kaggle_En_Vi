# scripts/baseline_feature_utils.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
def append_seed_features(X, seed_features: np.ndarray):
    if seed_features is None or seed_features.size == 0:
        return X
    from scipy.sparse import csr_matrix, hstack

    seed_sparse = csr_matrix(seed_features)
    return hstack([X, seed_sparse], format="csr")
